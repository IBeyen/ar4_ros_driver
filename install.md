...
2. Run `git clone https://github.com/RPI-Robotics/ar4_ros_driver.git` within your WSL or native linux filesystem.

3. `cd` to the ar4_ros_driver directory
...
You can run the simulation by opening the command pallete (`Ctrl+Shift+P`) and searching `Tasks:Run Task`.